...
// 애플 지문 스타일 UI 주입
const loginHtml = `
    <div id="loginOverlay" style="position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(245,245,247,0.7); backdrop-filter:blur(25px) saturate(180%); -webkit-backdrop-filter:blur(25px) saturate(180%); z-index:99999; display:flex; align-items:center; justify-content:center;">
        <div id="loginBox" style="background:rgba(255,255,255,0.8); padding:50px; border-radius:32px; box-shadow:0 20px 60px rgba(0,0,0,0.1); width:380px; text-align:center; border:1px solid rgba(255,255,255,0.8); opacity:0; transform:translateY(20px); transition:0.5s;">
            ...
            <p style="color:#86868b; margin-bottom:30px;">@hancom.com 계정으로 인증해 주세요.</p>
